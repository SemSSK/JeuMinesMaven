...
public class Board extends JPanel {
    ...
    public Board(JLabel statusbar2) {
    ...
    class MinesAdapter extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (x < Board.this.cols * 15 && y < Board.this.rows * 15) {
                if (e.getButton() == 3) {
                    if (Board.this.field[(Board.this.cols * cRow) + cCol] > 9) {
                        rep = true;
                        if (Board.this.field[(Board.this.cols * cRow) + cCol] > 19) {
                            int[] access$3 = Board.this.field;
                            int access$1 = (Board.this.cols * cRow) + cCol;
                            access$3[access$1] = access$3[access$1] - 10;
                        ...
                        } else if (Board.this.mines_left > 0) {
                            int[] access$32 = Board.this.field;
                            int access$12 = (Board.this.cols * cRow) + cCol;
                            access$32[access$12] = access$32[access$12] + 10;
                            Board board2 = Board.this;
                            board2.mines_left = board2.mines_left - 1;
                            Board.this.statusbar.setText(Integer.toString(Board.this.mines_left));
                        } else {
                            Board.this.statusbar.setText("No marks left");
                        }
                    }
                } else if (Board.this.field[(Board.this.cols * cRow) + cCol] > 19) {
                    return;
                } else {
                    if (Board.this.field[(Board.this.cols * cRow) + cCol] > 9 && Board.this.field[(Board.this.cols * cRow) + cCol] < 29) {
                        int[] access$33 = Board.this.field;
                        int access$13 = (Board.this.cols * cRow) + cCol;
                        access$33[access$13] = access$33[access$13] - 10;
                        rep = true;
                        if (Board.this.field[(Board.this.cols * cRow) + cCol] == 9) {
                            Board.this.inGame = false;
                        }
                        if (Board.this.field[(Board.this.cols * cRow) + cCol] == 0) {
                            Board.this.find_empty_cells((Board.this.cols * cRow) + cCol);
                        }
                    }
                }
                if (rep) {
